    ...
    return (
      <div className={styles.base}>
        ...
        <section id="version">
          ...
          <p>
            Commit SHA:{' '}
            <a target="_blank" href={`https://github.com/MiskaWasTaken/cryptnet/commit/${COMMIT_SHA}`}>
              {COMMIT_SHA}
            </a>
          </p>
        </section>
        ...
        <section id="acceptable-use">
          ...
          <p>
            You may not use, or encourage, promote, facilitate or instruct others to use, the Services or CryptNet Site
          ...
          of the Services or CryptNet Site. We may:
          <ul>
            <li>investigate violations of this Policy or misuse of the Services or CryptNet Site; or</li>
            <li>
              remove, disable access to, or modify any content or resource that violates this Policy or any other
              agreement we have with you for use of the Services or the CryptNet Site.
            </li>
            <li>
        ...
        <section id="terms">
          ...
          <p>
            CryptNet has no control over, and assumes no responsibility for, the content, privacy policies, or practices
            of any third party web sites or services. You further acknowledge and agree that CryptNet shall not be
        ...
        <section id="disclaimer">
          <h4>Disclaimer</h4>
          <p className="bold">
            WARNING: CryptNet does not mask IP addresses nor can verify the integrity of parties recieving messages.
          ...
          <p>
            <strong>
              OUR WEBSITE IS OPERATED BY CryptNet ON AN "AS IS," "AS AVAILABLE" BASIS, WITHOUT REPRESENTATIONS OR
              WARRANTIES OF ANY KIND. TO THE FULLEST EXTENT PERMITTED BY LAW, CryptNet SPECIFICALLY DISCLAIMS ALL
              ...
              YOU PURCHASE THROUGH IT. CryptNet SHALL NOT HAVE ANY LIABILITY OR RESPONSIBILITY FOR ANY ERRORS OR
              ...
              ARE AT YOUR OWN RISK. IN NO EVENT SHALL EITHER CryptNet OR THEIR AGENTS BE LIABLE FOR ANY DIRECT,
              ...
              SUCH DAMAGES. IN NO EVENT SHALL CryptNet’s LIABILITY FOR ANY DAMAGE CLAIM EXCEED THE AMOUNT PAID BY YOU TO
              CryptNet FOR THE TRANSACTION GIVING RISE TO SUCH DAMAGE CLAIM.
            </strong>
          </p>
          <p>
            <strong>
          ...
          <p>
            <strong>
              WITHOUT LIMITING THE FOREGOING, CryptNet DO NOT REPRESENT OR WARRANT THAT THE INFORMATION ON THE WEBITE IS
          ...
          <p>
            <strong>
              ...
              NATURE, INCLUDING LOSS, DAMAGE, OR WARRANTY. CryptNet AND THEIR RESPECTIVE AFFILIATES MAKE NO
              REPRESENTATION OR GUARANTEES ABOUT ANY CONTRACTS AND SERVICES OFFERED THROUGH OUR WEBSITE.
            </strong>
          </p>
          <p>
            <strong>
              CryptNet MAKES NO REPRESENTATION THAT CONTENT PROVIDED ON OUR WEBSITE, CONTRACTS, OR RELATED SERVICES ARE
              APPLICABLE OR APPROPRIATE FOR USE IN ALL JURISDICTIONS.
            </strong>
          </p>
          <strong>Indemnification</strong>
          <p>
            You agree to defend, indemnify and hold CryptNet harmless from and against any and all claims, damages,
        ...
        <section id="donate">
          <h4>Donate</h4>
          <p>
            CryptNet is maintained and hosted by a developer who is still recieving education. If you get some value from this
